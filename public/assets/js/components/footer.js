const Footer = () => {
    ...
    const footerleft = $('<div class="col-md-4 footer-left"></div>');
    ...
    const footercenter = $('<div class="col-md-4 footer-center"></div>');
    const textfootcenter = $('<ul><li>DIRECTOR GENERAL:</li><li>Francisco Miró Quesada Cantuarias</li><li>DIRECTOR PERIODÍSTICO:</li><li>Fernando Berckemeyer Olaechea</li><li>SUSCRIPCIONES:</li> <li>suscriptores@comercio.com.pe</li><li>PUBLICIDAD ONLINE:</li><li>fonoavisos@comercio.com.pe</li><li>CLUB EL COMERCIO:</li><li>clubelcomercio@comercio.com.pe</li><li>Compromiso de Autorregulación Comercial</li></ul>');
    const footer_right = $('<div class="col-md-4 footer-rigth"></div>');
